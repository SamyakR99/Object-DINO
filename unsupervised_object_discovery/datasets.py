...
class Dataset:
    def __init__(self, dataset_name, dataset_set, remove_hards):
        ...
        if dataset_name == "VOC07":
            self.root_path = "/scratch/bcyh/dataset/VOC2007"
            self.year = "2007"
        elif dataset_name == "VOC12":
            self.root_path = "/scratch/bcyh/dataset/VOC2012"
            self.year = "2012"
        elif dataset_name == "COCO20k":
            self.year = "2014"
            self.root_path = f"/scratch/bcyh/dataset/coco20k/images/{dataset_set}{self.year}"
            self.sel20k = '/scratch/bcyh/dataset/coco_20k_filenames.txt'
            # JSON file constructed based on COCO train2014 gt 
            self.all_annfile = "/scratch/bcyh/dataset/coco20k/annotations/instances_train2014.json"
            self.annfile = "/scratch/bcyh/dataset/instances_train2014_sel20k.json"
    ...
    def load_image(self, im_name):
        ...
        if "VOC" in self.dataset_name:
            image = skimage.io.imread(f"/scratch/bcyh/dataset/VOC{self.year}/VOCdevkit/VOC{self.year}/JPEGImages/{im_name}")
            ...
            image = skimage.io.imread(f"/scratch/bcyh/dataset/coco20k/images/train2014/{im_name}")
        else:
