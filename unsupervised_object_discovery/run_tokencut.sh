...
cd /scratch/bcyh/samyakr99/TokenCut


# Pretraining

CUDA_VISIBLE_DEVICES="0" $python main_tokencut_copy.py --dataset COCO20k --set train --which_features samyak --arch vit_base --tau -0.5
